import { MousePointer2, PenLine, StickyNote } from 'lucide-react'
...
export function AnnotationTools({ tool, penColor, onToolChange, onPenColorChange }: AnnotationToolsProps) {
  return (
